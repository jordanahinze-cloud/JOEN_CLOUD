...
Mestre do Hectare: No jogo, o jogador precisa fazer os cálculos para descobrir a melhor distribuição de plantio no hectare e, em seguida, selecionar a alternativa correta entre as opções disponíveis. Ou seja, não basta apenas entender o conceito: é necessário resolver o problema, comparar os resultados e escolher a alternativa que representa a solução mais eficiente para o uso do solo agrícola.

Trator Reflorestador: o jogador pilota um trator ecológico com a missão de recuperar áreas desmatadas em larga escala. Ao jogar, o usuário aprende sobre a importância do reflorestamento, a recuperação de ecossistemas degradados e o papel das árvores na proteção do solo e do clima.

Coleta Seletiva: o jogador deve separar corretamente embalagens e resíduos nas lixeiras adequadas. Cada tipo de material, como papel, plástico, vidro e metal, precisa ser descartado no recipiente correto, exigindo atenção e conhecimento sobre reciclagem. O objetivo é treinar a consciência ambiental, mostrando a importância da separação do lixo para reduzir a poluição e facilitar o reaproveitamento dos materiais.
